...
void check_distance(unsigned int distance, int test_id) {
    switch(test_id) {
        ...
        case 10: printf("Testing with image translated to left-of-center rectangular...%s\n", distance==0?"passed":"failed"); break;
        case 11: printf("Testing with image translated to left-of-center and rotated...%s\n", distance==0?"passed":"failed"); break;
